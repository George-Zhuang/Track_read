...
def get_args_parser():
    ...
    parser.add_argument('--extra_track_attn', default=True)
    ...
    parser.add_argument('--output_dir', default='exps/e2e_motr_r50_joint',
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default='exps/e2e_motr_r50_joint/motr_final.pth', help='resume from checkpoint')
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--eval', action='store_true')
    parser.add_argument('--vis', action='store_true')
    parser.add_argument('--num_workers', default=2, type=int)
    parser.add_argument('--pretrained', default='./weights/r50_deformable_detr_plus_iterative_bbox_refinement-checkpoint.pth', help='resume from checkpoint')
    parser.add_argument('--cache_mode', default=False, action='store_true', help='whether to cache images on memory')

    # end-to-end mot settings.
    parser.add_argument('--mot_path', default='./data', type=str)
    parser.add_argument('--input_video', default='figs/demo.avi', type=str)
    ...
    parser.add_argument('--merger_dropout', type=float, default=0)
    parser.add_argument('--update_query_pos', default=True)

    parser.add_argument('--sampler_steps', type=int, default=[5,9,15])
    parser.add_argument('--sampler_lengths', type=int, default=[2,3,4,5])
    ...
    parser.add_argument('--use_checkpoint', default=True)
    return parser
