...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='exps/e2e_motr_r50_dance',
    ...
    parser.add_argument('--pretrained', default='exps/e2e_motr_r50_joint', help='resume from checkpoint')
